...
namespace Digger.Demo.Runtime_Scene
{
    /// <summary>
    ...
    public class DiggerRuntimeUsageExample : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (UnityEngine.Input.GetKeyDown(keyToPersistData))
            {
            ...
            else if (UnityEngine.Input.GetKeyDown(keyToDeleteData))
            {
            ...
            else if (UnityEngine.Input.GetKeyDown(keyToClearScene))
            {
